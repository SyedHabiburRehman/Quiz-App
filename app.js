...
var questionArray = [
    {
        question : "Q. Objective Resolution was passed by the Constituent Assembly of Pakistan on:",
        op1 : "March 12, 1947",
        op2 : "March 12, 1948",
        op3 : "March 12, 1949",
    ...
    {
        question : "Q. The world's highest mountain is in __________.",
        op1 : "China",
        op2 : "Pakistan",
        op3 : "Nepal",
        correctAnswer : "Nepal"
    ...
    {
        question : "Q. The largest ocean of the world is __________.",
        op1 : "Atlanta",
        op2 : "Pacific",
        op3 : "Indian",
    ...
    {
        question : "Q. The Capital of Canada is __________.",
        op1 : "Tirane",
        op2 : "Ottawa",
        op3 : "Athens",
    ...
    {
        question : "Q. The currency of Israel is _________.",
        op1 : "Euro",
        op2 : "Shekel",
        op3 : "Forint",
    ...
    {
        question : "Q. The highest part of the Earth is __________ .",
        op1 : "Mount Everest",
        op2 : "K2",
        op3 : "Norway",
    ...
    {
        question : "Q. The deepest part of the Earth is __________ .",
        op1 : "Dead Sea",
        op2 : "Mariana Trench",
        op3 : "South Africa",
...
{
        question : "Q. Emirates is an airline of __________.",
        op1 : "Saudi Arabia",
        op2 : "Qatar",
        op3 : "UAE",
        correctAnswer : "UAE"
    ...
    {
        question : "Q. The Earth surface is divided in __________ Continents.",
        op1 : "5",
        op2 : "6",
        op3 : "7",
        correctAnswer : "7"
    ...
    {
        question : "Q. The hottest desert of the world is?",
        op1 : "Sahara Desert",
        op2 : "Arabian Desert",
